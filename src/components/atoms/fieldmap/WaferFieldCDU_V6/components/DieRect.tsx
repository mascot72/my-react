  ...
  return (
    <g key={dieKey}>
      <rect
        ...
        fill={
          applyDieFillFromSemValue && getDieFillColor && fieldGridX !== undefined && fieldGridY !== undefined && dieCol !== undefined && dieRow !== undefined
            ? getDieFillColor(fieldGridX, fieldGridY, dieCol, dieRow) || (die.cdu == null ? '#fff' : cduToColor(die.cdu))
            : die.cdu == null ? '#fff' : cduToColor(die.cdu)
        }
